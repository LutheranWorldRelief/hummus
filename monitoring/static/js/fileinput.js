...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgProgress: gettext('Loading file {index} of {files} - {name} completed.'),
        msgSelected: gettext('{n} {files} selected'),
        msgFoldersNotAllowed: gettext('Drag & drop files only! not folder(s).'),
        ...
        msgAjaxError: gettext('Something went wrong with the {operation} operation.'),
