...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        removeTitle: gettext('Clear selected files'),
        cancelLabel: gettext('Cancel'),
        cancelTitle: gettext('Abort ongoing upload'),
        uploadLabel: gettext('Upload'),
        uploadTitle: gettext('Upload selected files'),
        msgNo: gettext('No'),
        msgNoFilesSelected: gettext('No files selected'),
        msgCancelled: gettext('Cancelled'),
        msgPlaceholder: gettext('Select {files}...'),
        msgZoomModalHeading: gettext('Detailed Preview'),
        msgFileRequired: gettext('You must select a file to upload.'),
        msgSizeTooSmall: gettext('File "{name}" (<b>{size} KB</b>) is too small and must be larger than <b>{minSize} KB</b>.'),
        msgSizeTooLarge: gettext('File "{name}" (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>.'),
        msgFilesTooLess: gettext('You must select at least <b>{n}</b> {files} to upload.'),
        msgFilesTooMany: gettext('Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>.'),
        msgFileNotFound: gettext('File "{name}" not found!'),
        msgFileSecured: gettext('Security restrictions prevent reading the file "{name}".'),
        msgFileNotReadable: gettext('File "{name}" is not readable.'),
        msgFilePreviewAborted: gettext('File preview aborted for "{name}".'),
        msgFilePreviewError: gettext('An error occurred while reading the file "{name}".'),
        msgInvalidFileName: gettext('Invalid or unsupported characters in file name "{name}".'),
        msgInvalidFileType: gettext('Invalid type for file "{name}". Only "{types}" files are supported.'),
        msgInvalidFileExtension: gettext('Invalid extension for file "{name}". Only "{extensions}" files are supported.'),
        msgFileTypes: {
            'image': gettext('image'),
            'html': gettext('HTML'),
            'text': gettext('text'),
            ...
            'flash': gettext('flash'),
            'pdf': gettext('PDF'),
            'object': gettext('object')
        },
        msgUploadAborted: gettext('The file upload was aborted'),
        msgUploadThreshold: gettext('Processing...'),
        msgUploadBegin: gettext('Initializing...'),
        msgUploadEnd: gettext('Done'),
        msgUploadEmpty: gettext('No valid data available for upload.'),
        msgUploadError: gettext('Error'),
        msgValidationError: gettext('Validation Error'),
        msgLoading: gettext('Loading file {index} of {files} &hellip;'),
        msgProgress: gettext('Loading file {index} of {files} - {name} - {percent}% completed.'),
        msgSelected: gettext('{n} {files} selected'),
        msgFoldersNotAllowed: gettext('Drag & drop files only! {n} folder(s) dropped were skipped.'),
        msgImageWidthSmall: gettext('Width of image file "{name}" must be at least {size} px.'),
        msgImageHeightSmall: gettext('Height of image file "{name}" must be at least {size} px.'),
        msgImageWidthLarge: gettext('Width of image file "{name}" cannot exceed {size} px.'),
        msgImageHeightLarge: gettext('Height of image file "{name}" cannot exceed {size} px.'),
        msgImageResizeError: gettext('Could not get the image dimensions to resize.'),
        msgImageResizeException: gettext('Error while resizing the image.<pre>{errors}</pre>'),
        msgAjaxError: gettext('Something went wrong with the {operation} operation. Please try again later!'),
        msgAjaxProgressError: gettext('{operation} failed'),
        ajaxOperations: {
            deleteThumb: gettext('file delete'),
            uploadThumb: gettext('file upload'),
            uploadBatch: gettext('batch file upload'),
            uploadExtra: gettext('form data upload')
        },
        dropZoneTitle: gettext('Drag & drop files here &hellip;'),
        dropZoneClickTitle: gettext('<br>(or click to select {files})'),
        previewZoomButtonTitles: {
            prev: gettext('View previous file'),
            next: gettext('View next file'),
            toggleheader: gettext('Toggle header'),
            fullscreen: gettext('Toggle full screen'),
            borderless: gettext('Toggle borderless mode'),
            close: gettext('Close detailed preview')
        },
